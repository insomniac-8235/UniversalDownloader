...
class UniversalDownloader(ctk.CTk):
    def __init__(self):
        ...
        # --- THEME CONSTANTS ---
        self.APP_BG = ("#ebebeb", "#242424")
        self.ENTRY_BG = ("#fcfcfc", "#343424")
        self.BORDER_HIDDEN = self.APP_BG
        self.BORDER_DEFAULT = ("#999999", "#444444")
        self.ENTRY_FOCUS = ("#1976D2", "#1976D2")
        self.ACTION_BTN = ("#1976D2", "#1976D2")
        self.BTN_DISABLED = ("#FCFCFC", "#343434")
        self.ACTION_HOVER = ("#448BD3", "#448BD3")
        self.TEXT_DISABLED = ("#CECECE", "#666666")
        self.ACTION_TEXT = ("#EBEBEB", "#EBEBEB")
        self.PROG_FILL = ("#1976D2", "#1976D2")
        self.TEXT_MAIN = ("#444444", "#D4D4D4")
        self.TEXT_GHOST = ("#666666", "#d4d4d4")
        self.TEXT_VERSION = ("#888888", "#555555")
