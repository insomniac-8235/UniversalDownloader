...
class UIController:
    ...
    def setup_ui(self):
        ...
        self.url_container = ctk.CTkFrame(
            ...
            border_width=2,
            border_color=self.theme["BORDER_HIDDEN"][0]
        )
        ...
        self.paste_btn = ctk.CTkButton(
            ...
            height=36,
            corner_radius=18,
            bg_color=self.theme["ENTRY_BG"][0],
        ...
        self.audio_switch = ctk.CTkSwitch(
            ...
            button_hover_color=self.theme["ACTION_HOVER"][0],
            border_width=2,
            border_color=self.theme["ACTION_BTN"][0]
        )
        ...
        self.progress_bar = ctk.CTkProgressBar(
            ...
            height=16,
            fg_color=self.theme["ENTRY_BG"][0],
            progress_color=self.theme["PROG_FILL"][0],
            corner_radius=8,
            mode="determinate"
        )
    ...
    def bind_events(self):
        ...
        self.url_entry.bind("<Enter>", lambda e: self.url_entry.configure(border_color=self.theme["BORDER_DEFAULT"][0]))
        ...
        self.folder_entry.bind("<Enter>", lambda e: self.folder_entry.configure(border_color=self.theme["BORDER_DEFAULT"][0]))
    ...
    def on_focus_in(self, widget):
        widget.configure(border_color=self.theme["ENTRY_FOCUS"][0])
        widget.configure(text_color=("#000000", "#ffffff"))
        
    def on_focus_out(self, widget):
        if not widget.get().strip():
            widget.configure(border_color=self.theme["BORDER_HIDDEN"][0])
        else:
            widget.configure(border_color=self.theme["BORDER_DEFAULT"][0])
            widget.configure(text_color=self.theme["TEXT_MAIN"][0])
    ...
    def select_folder(self):
        ...
        if folder:
            ...
            self.folder_entry.configure(text_color=self.theme["TEXT_MAIN"][0], border_color=self.theme["BORDER_DEFAULT"][0])
